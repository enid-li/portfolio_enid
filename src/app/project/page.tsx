...
interface ProjectComponent1 {
    title: string;
    subtitle: string;
    description: string;
}

function ProjectComponent1({ title, subtitle, description }: ProjectComponent1) {
    return (
        <div className="flex flex-col container mx-auto px-8 md:px-12 py-12">
            <h2 className="text-4xl font-medium py-4">{title}</h2>
